...
class WNTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w500, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w500, color: Colors.white),
